...
class Specialty1 extends ImageIcon {
    ...
    Specialty1() {
        super("src/main/resources/file/Specialty11.jpg");
    }
}
...
class Specialty2 extends ImageIcon {
    ...
    Specialty2() {
        super("src/main/resources/file/Specialty12.jpg");
    }
}
...
class Specialty3 extends ImageIcon {
    ...
    Specialty3() {
        super("src/main/resources/file/Specialty13.jpg");
    }
}
...
class Specialty4 extends ImageIcon {
    ...
    Specialty4() {
        super("src/main/resources/file/Specialty14.jpg");
    }
}
...
class Specialty5 extends ImageIcon {
    ...
    Specialty5() {
        super("src/main/resources/file/Specialty21.jpg");
    }
}
...
class Specialty6 extends ImageIcon {
    ...
    Specialty6() {
        super("src/main/resources/file/Specialty22.jpg");
    }
}
...
class Specialty7 extends ImageIcon {
    ...
    Specialty7() {
        super("src/main/resources/file/Specialty23.jpg");
    }
}
...
class Specialty8 extends ImageIcon {
    ...
    Specialty8() {
        super("src/main/resources/file/Specialty24.jpg");
    }
}
